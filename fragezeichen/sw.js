...
/* =============================================================================
 * Service Worker - Offline-Unterstützung für /fragezeichen/
 * -----------------------------------------------------------------------------
 ...
 * ========================================================================== */
var CACHE_VERSION = 'fragezeichen-v2';

// Alle Pfade relativ zu diesem Skript (liegt in /fragezeichen/), damit sie
// sowohl auf GitHub Pages als auch bei einem lokalen Server unter jedem
// Basis-Pfad funktionieren.
var APP_SHELL = [
    './',
    './index.html',
    './manifest.json',
...
self.addEventListener('fetch', function (event) {
    ...
    // Nur eigene Assets über den Cache bedienen - Anfragen an Spotify (Cover/
    // Titel per oEmbed) laufen ungefiltert durchs Netz, da sie sich laufend
    // ändern und ohnehin nur online sinnvoll sind.
